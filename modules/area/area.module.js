...
AreaModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([area_entity_1.AreaEntity, property_entity_1.PropertyEntity, user_entity_1.User])],
        controllers: [area_controller_1.AreaController],
        providers: [area_service_1.AreaService, property_service_1.PropertyService, users_service_1.UsersService]
    })
], AreaModule);
