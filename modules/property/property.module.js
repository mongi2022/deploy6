...
PropertyModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([property_entity_1.PropertyEntity, user_entity_1.User])],
        controllers: [property_controller_1.PropertyController],
        providers: [property_service_1.PropertyService, users_service_1.UsersService]
    })
], PropertyModule);
